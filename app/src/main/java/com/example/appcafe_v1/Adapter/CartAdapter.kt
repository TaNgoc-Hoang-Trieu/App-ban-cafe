...
import com.example.appcafe_v1.databinding.ViewholderCartBinding
...
,context: Context, var changeNumberItemsListener: ChangeNumberItemsListener?=null
    ...
    private val managment = ManagmentCart(context)
    ...
    override fun onBindViewHolder(holder: CartAdapter.ViewHolder, position: Int) {
        ...
        holder.binding.plusCartBtn.setOnClickListener {
            managment.plusItem(listItemSelected, position, object :
        ...
        holder.binding.minusCartBtn.setOnClickListener {
            managment.minusItem(listItemSelected, position, object :
                ChangeNumberItemsListener {
                override fun onChanged() {
                    notifyDataSetChanged()
                    changeNumberItemsListener?.onChanged()
